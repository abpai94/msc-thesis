...
public class Terrorism implements LuxMapGenerator  {
...
//		<polygon>699,84 687,85 682,93 676,95 672,101 666,118 673,123 676,144 686,139 690,158 695,147 698,135 712,120 713,107 705,89</polygon>
  ...
  public String description() {
    return "Terrorism takes an existing map file and generates hidden terrorist connections between countries. It creates hidden one-way connections between countries, representing foreign terror cells operating within another country's borders.";
  }
  
  //user size choices
  static final String CHOICE_CLASSIC_L = "Terrorism - Classic - Light";
  static final String CHOICE_CLASSIC_M = "Terrorism - Classic - Medium";
  static final String CHOICE_CLASSIC_H = "Terrorism - Classic - Heavy";
  static final String CHOICE_CLASSIC_E = "Terrorism - Classic - Extreme";
  static final String CHOICE_DEUX_L = "Terrorism - Deux - Light";
  static final String CHOICE_DEUX_M = "Terrorism - Deux - Medium";
  static final String CHOICE_DEUX_H = "Terrorism - Deux - Heavy";
  static final String CHOICE_DEUX_E = "Terrorism - Deux - Extreme";
