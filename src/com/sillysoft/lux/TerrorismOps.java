...
// TerrorismOps.java
//
// Terrorism takes an existing map file and generates
...
// country's borders. This version adds a grenade icon
// to indicate countries with a terror cell.
//
// Created on August 28, 2007, 12:00 AM
//
//  Version: 1.0 (5/8/07)
//           1.2 (9/19/07) - branched Ops version
//
...
public class TerrorismOps implements LuxMapGenerator  {
  ...
  private int GetMapSize(String mapName) {
    ...
    try {
      ...
      e.printStackTrace();
        throw new RuntimeException("Could not load the map file. Install the "+mapName+" map and try again.");
    }
...
//<line><position>378,226 382,226</position><color>0.0/0.2/0.2</color><above>true</above></line>
  ...
  public String description() {
    return "Terrorism takes an existing map file and generates hidden terrorist connections between countries. It creates hidden one-way connections between countries, representing foreign terror cells operating within another country's borders. The Ops version of the generator creates maps where the countries operating a terror cell are visible (indicated with a grenade icon on the map).";
  }
  
//user size choices
  static final String CHOICE_CLASSIC_L = "TerrorismOps - Classic - Light";
  static final String CHOICE_CLASSIC_M = "TerrorismOps - Classic - Medium";
  static final String CHOICE_CLASSIC_H = "TerrorismOps - Classic - Heavy";
  static final String CHOICE_CLASSIC_E = "TerrorismOps - Classic - Extreme";
  static final String CHOICE_DEUX_L = "TerrorismOps - Deux - Light";
  static final String CHOICE_DEUX_M = "TerrorismOps - Deux - Medium";
  static final String CHOICE_DEUX_H = "TerrorismOps - Deux - Heavy";
  static final String CHOICE_DEUX_E = "TerrorismOps - Deux - Extreme";
